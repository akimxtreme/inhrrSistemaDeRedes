...
<form class="host" action="bd_editar_formulario_host.php" onsubmit="return agregar_equipo(this);" method="post">
<!-- Titulo -->
<h1 class="host">Tipo de Equipo</h1>
...
<?php
			...
			$id_tipo_equipo1=$row['id'];
echo "<option class='host' value='" .  $id_tipo_equipo1 . "'>" .  $tipo_equipo1 . '</option>';			
?>
...
<div class="host"></div>
<form class="host" action="bd_editar_formulario_host.php" onsubmit="return agregar_conexion(this);" method="post">
<!-- Titulo -->
<h1 class="host">Tipo de Conexión</h1>
...
<?php
			...
			$id_tipo_conexion1=$row['id'];
echo "<option class='host' value='" .  $id_tipo_conexion1 . "'>" .  $tipo_conexion1 . '</option>';			
?>

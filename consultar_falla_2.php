...
<?php
$sql="SELECT * FROM log_host WHERE id_host='$id'";
...
<form class="host_consulta" action=""  method="post">
<!-- Titulo -->
<h1 class="host">Accion: <?php echo $accion_bd;?></h1>

<!-- Usuario Administrador (usuario_bd) -->
<div class="organizar">
<label class="host">Usuario Administrador</label>
<?php if ($usuario_bd!='') {echo "<input class='host_2' type='text' name='nomb_host' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $usuario_bd . "'/>"; } ?>
</div>

<!-- Acción (accion_bd) -->
<div class="organizar">
<label class="host">Acción</label>
<?php if ($accion_bd!='') {echo "<input class='host_2' type='text' name='nomb_host' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $accion_bd . "'/>"; } ?>
</div>

<!-- Fecha de Ejecución (fecha_accion_bd) -->
<div class="organizar">
<label class="host">Fecha de Ejecución</label>
<?php if ($fecha_accion_bd!='') {echo "<input class='host_2' type='text' name='nomb_host' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $fecha_accion_bd . "'/>"; } ?>
</div>

<!-- Hora de Ejecución (hora_accion_bd) -->
<div class="organizar">
<label class="host">Hora de Ejecución</label>
<?php if ($hora_accion_bd!='') {echo "<input class='host_2' type='text' name='nomb_host' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $hora_accion_bd . "'/>"; } ?>
</div>

<!-- Nombre del Host (nomb_host) -->
<div class="organizar">
<label class="host">Nombre de Host</label>
<?php if ($nomb_host_bd!='') {echo "<input class='host_2' type='text' name='nomb_host' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $nomb_host_bd . "'/>"; } ?>
</div>
<!-- Tipo de Equipo (tipo_equipo) -->
<div class="organizar">
<label class="host">Tipo de Equipo</label>
<?php if ($tipo_equipo_bd!='') {echo "<input class='host_2' type='text' name='tipo_equipo' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $tipo_equipo_bd . "'/>"; } ?>
</div>
<!-- Tipo de Conexión (tipo_conexion) -->
<div class="organizar">
<label class="host">Tipo de Conexión</label>
<?php if ($tipo_conexion_bd!='') {echo "<input class='host_2' type='text' name='tipo_conexion' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $tipo_conexion_bd . "'/>"; } ?>
</div>
<!-- Unidad (gerencia) -->
<div class="organizar">
<label class="host">Unidad</label>
<?php if ($unidad_bd!='') {echo "<input class='host_2' type='text' name='gerencia' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $nombre_unidad_bd . "'/>"; } ?>
</div>
<!-- Personal (nomb_usuario) (nomb_usuario_otro) -->
<div class="organizar">
<label class="host">Personal</label>
<?php if ($nomb_usuario_bd!='') {echo "<input class='host_2' type='text' name='nomb_usuario' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $nomb_usuario_bd . "'/>"; } ?>
</div>
<!-- Personal (cedula_usuario) -->
<div class="organizar">
<label class="host">Cédula de Personal</label>
<?php if ($cedula_usuario_bd!='') {echo "<input class='host_2' type='text' name='nomb_usuario' id='nomb_host' disabled='disabled' maxlength='8' onblur='obligatorio(this);' value='" . $cedula_usuario_bd . "'/>"; } ?>
</div>

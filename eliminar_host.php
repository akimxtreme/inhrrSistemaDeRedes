...
<h1 class="host">Eliminar Host</h1>
	 ...
	 /*******************/
	  ...
	  while ($row = mysql_fetch_array($seleccion)){
           ...
           <tr class="host_2">
                 ...
                 <form action="bd_eliminar_host.php" method="post" >
                ...
                <td class="host">
                <input type='hidden' name='id_1' value='<?php echo $row["id"]; ?>'/>
                <input type='hidden' name='elimina' value='Eliminar'/>
                <input type="image" valign='middle' src='imagenes/eliminar.png' border="0"/>
                
           <!--<input type="submit" value="Eliminar" name="elimina" />-->

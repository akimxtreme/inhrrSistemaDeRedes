...
<h1 class="host">Consulta de Log</h1>
    ...
    <option class="host" value="log_historico_host">Log (Módulo de Histórico de Fallas)</option>
    </select>
    </div>
...
$sql="select * from $campo";
	...
	if($campo=="log_host"){
	  ...
	  while ($row = mysql_fetch_array($seleccion)){
		  ...
		  echo "<tr class='host_2'>";
          echo "<form action='consultar_log_2.php' method='get' >";
          echo "<td class='host'>" . $usuario_bd . "</td>";
          echo "<td class='host'>" . $accion_bd . "</td>";
          echo "<td class='host'>" . $fecha_accion_bd . "</td>";
          echo "<td class='host'>" . $hora_accion_bd . "</td>";
          echo "<td class='host'>" . $id_host_bd . "</td>";
          echo "<td class='host'>";
          echo "<input type='hidden' name='id' value='" . $id_host_bd . "'>";
		  echo "<input type='hidden' name='tabla' value='" . $campo . "'>";
          echo "<input type='image' valign='middle' name='edita'  src='imagenes/consultar.png' value='Editar' border='0'/>";

...
<h1 class="host">Modificar Host</h1>
	 ...
	 /*******************/
	  ...
	  while ($row = mysql_fetch_array($seleccion)){
           ...
           <tr class="host_2">
                 ...
                 <form action="modificar_host_2.php" method="get" >
                ...
                <input type="image" valign='middle' name='edita'  src='imagenes/editar.png' value="Editar" border="0"/>
                <div class="derecha">
